...
export const Section3 = ({
	...
	return (
		<div className='content-container flex flex-col items-center md:flex-row md:justify-between md:mb-20 lg:mb-[180px] '>
			<div className='overflow-hidden rounded-lg mb-6 max-w-[523px] max-h-[300px]'>
				<picture>
			...
			<div className='bg-white-400 h-[300px] flex flex-col justify-center rounded-lg mb-6 w-full md:w-1/2 flex-shrink-0 md:ml-4 lg:ml-8 max-w-[523px]'>
